...
The superclass L<Class::Value> defines these methods and functions:
    ...
    send_notify_value_not_wellformed(), set_value(), sin(), skip_checks(),
    skip_dirtying(), skip_normalizations(), sqrt(), str_cmp(), stringify(),
    subtract(), throw_single_exception(), try(), value(), with()
...
This document describes version 0.03 of L<Class::Value::Net::Hostname>.
