...
The superclass L<Error::Hierarchy> defines these methods and functions:
    ...
    is_optional_set(), line(), message(), package(), properties_as_hash(),
    set_acknowledged(), set_is_optional(), stacktrace(), stringify(),
    transmute(), uuid()
...
This document describes version 0.02 of L<Class::Value::Net::Exception::MalformedHostname>.
